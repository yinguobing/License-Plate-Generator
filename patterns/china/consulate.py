...
targets = [tokens.PROVINCES, tokens.DIGITS, tokens.DIGITS, tokens.DIGITS,
           tokens.DIGITS, mixed, '领']

# 每一位字符的位置：左上角的像素坐标
locations = [(15, 25), (72, 25), (127, 25), (184, 25),
...
# 背景图像的路径
background_file = 'assets/background/black/consulate/140.png'
