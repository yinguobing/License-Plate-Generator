...
# 每一位字符可以使用的的字符组
targets = [tokens.DIGITS, tokens.DIGITS, tokens.DIGITS, tokens.DIGITS,
           tokens.DIGITS, tokens.DIGITS, '使']

# 每一位字符的位置：左上角的像素坐标
locations = [(15, 25), (72, 25), (127, 25), (208, 25),
...
# 背景图像的路径
background_file = 'assets/background/black/embassy/140.png'
...
EMBASSY = Pattern(
    ...
    valid_token_set=list(
        chain(tokens.PROVINCES, tokens.ALPHABETS, tokens.DIGITS, '领'))
)
